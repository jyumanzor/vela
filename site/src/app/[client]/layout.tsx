    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', paddingTop: 56 }}>
        <div style={{ textAlign: 'center' }}>
          <h1 style={{ fontFamily: fi, fontSize: 32, color: 'var(--moonlight)', marginBottom: 12 }}>Client not found</h1>
          <p style={{ fontFamily: fd, fontSize: 15, color: 'var(--dusk)' }}>
            No client matches &ldquo;{slug}&rdquo;.
          </p>
          <Link href="/" style={{ fontFamily: fd, fontSize: 14, color: 'var(--star-gold)', marginTop: 20, display: 'inline-block' }}>
            Back to Vela
          </Link>
        </div>
      </div>
